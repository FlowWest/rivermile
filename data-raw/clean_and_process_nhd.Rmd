...
```{r}
unique(klamath_rivers$river)

blue_creek <- rivermile::get_river_miles(klamath_rivers, "Blue Creek")
usethis::use_data(blue_creek, overwrite = TRUE)

bogus_creek <- rivermile::get_river_miles(klamath_rivers, "Bogus Creek")
usethis::use_data(bogus_creek, overwrite = TRUE)

clear_creek <- rivermile::get_river_miles(klamath_rivers, "Clear Creek")
usethis::use_data(clear_creek, overwrite = TRUE)

indian_creek <- rivermile::get_river_miles(klamath_rivers, "Indian Creek")
usethis::use_data(indian_creek, overwrite = TRUE)

jenny_creek <- rivermile::get_river_miles(klamath_rivers, "Jenny Creek")
usethis::use_data(jenny_creek, overwrite = TRUE)

link_river <- rivermile::get_river_miles(klamath_rivers, "Link River")
usethis::use_data(link_river, overwrite = TRUE)

klamath_river <- rivermile::get_river_miles(klamath_rivers, "Klamath River")
usethis::use_data(klamath_river, overwrite = TRUE)

lost_river <- rivermile::get_river_miles(klamath_rivers, "Lost River")
usethis::use_data(lost_river, overwrite = TRUE)

salmon_river <- rivermile::get_river_miles(klamath_rivers, "Salmon River")
usethis::use_data(salmon_river, overwrite = TRUE)

scott_river <- rivermile::get_river_miles(klamath_rivers, "Scott River")
usethis::use_data(scott_river, overwrite = TRUE)

shasta_river <- rivermile::get_river_miles(klamath_rivers, "Shasta River")
usethis::use_data(shasta_river, overwrite = TRUE)

sprague_river <- rivermile::get_river_miles(klamath_rivers, "Sprague River")
usethis::use_data(sprague_river, overwrite = TRUE)

trinity_river <- rivermile::get_river_miles(klamath_rivers, "Trinity River")
usethis::use_data(trinity_river, overwrite = TRUE)

williamson_river <- rivermile::get_river_miles(klamath_rivers, "Williamson River")
usethis::use_data(williamson_river, overwrite = TRUE)

wood_river <- rivermile::get_river_miles(klamath_rivers, "Wood River")
...
all_rivers <- unique(klamath_rivers$river)

for(i in 1:length(all_rivers)) {
  
  name <- gsub(" ", "_", tolower(all_rivers[i]))
  
  river <- rivermile::get_river_miles(klamath_rivers, all_rivers[i])
